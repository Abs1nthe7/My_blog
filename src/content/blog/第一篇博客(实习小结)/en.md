---
title: A Summary of My First Month as an Intern
pubDate: 2026-05-31
...
- finding `bugs`
- fixing `bugs`
- and then finding new `bugs`

Besides that, I also volunteered to participate in some `PV`-related work, which gave me the chance to learn a little more in that direction. I cannot really go into details here, though, since it involves confidentiality.
